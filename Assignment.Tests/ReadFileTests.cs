...
namespace Assignment.Tests
{
    public class ReadFileTests
	{
        ...
        public void ReadTypeOne_ShouldReturnSqlFormat()
        {
            ...
            //act
            string actual = ReadFile.ReadTypeOne(@"C:\customers_1.txt", "insert into customers(id, first_name, last_name, gender, date_of_birth, marital_status)", 400);
        ...
        public void ReadTypeTwo_ShouldReturnSqlFormat()
        {
            ...
            //act
            string actual = ReadFile.ReadTypeTwo(@"C:\customers_2.txt", "insert into customers(id, first_name, last_name, gender, date_of_birth, marital_status)", 400);
        ...
        public void ReadTypeThree_ShouldReturnSqlFormat()
        {
            ...
            //act
            string actual = ReadFile.ReadTypeThree(@"C:\customers_3.txt", "insert into customers(id, first_name, last_name, gender, date_of_birth, marital_status)", 400);
